...
//  g_WWeaponImages    :array of TWMImages;
  ...
  g_sSelChrAddr      :String = '0.0.0.0';
  g_nSelChrPort      :Integer = 7100;
  g_sRunServerAddr   :String = '127.0.0.1';
  g_nRunServerPort   :Integer = 5000;
  ...
  g_boViewFog               :Boolean;         //是否显示黑暗, True是, False 否
  g_boForceNotViewFog       :Boolean = False; //False; True;  //是否免蜡烛（即是否强制不查看雾），True免蜡烛 , False要蜡烛
